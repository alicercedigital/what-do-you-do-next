...
export function ItemEditor({
  ...
  const addModifier = () => {
    ...
    updateData({
      attributeModifiers: [
        ...
        { attributeId: availableAttributes[0].id, modifier: 1 },
      ],
    });
  };
  ...
  const updateModifier = (
    index: number,
    updates: Partial<ItemAttributeModifier>
  ) => {
  ...
  const distributableAttrs = attributes.filter(
    (a) => a.category === "distributable"
  );
        ...
        <TabsContent value="basic">
          <Card className="py-4">
            <CardHeader>
              ...
              <CardDescription>
                Define the item's name, type, and properties
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(v) =>
                    updateData({
                      type: v as "equipment" | "consumable" | "object",
                    })
                  }
                >
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="consumable">
                      <div className="flex flex-col items-start">
                        ...
                        <span className="text-xs text-muted-foreground">
                          One-time use, permanent effects
                        </span>
                      </div>
                    </SelectItem>
              ...
              {data.type === "equipment" && (
                <div className="space-y-2">
                  ...
                  <Select
                    value={data.slot || ""}
                    onValueChange={(v) => updateData({ slot: v })}
                  >
                    <SelectTrigger className="bg-transparent">
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">
                        Can multiple items stack in inventory
                      </p>
                    </div>
                    <Switch
                      checked={data.stackable}
                      onCheckedChange={(v) => updateData({ stackable: v })}
                    />
                  </div>
                  ...
                  {data.stackable && (
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          updateData({
                            maxStack: Number.parseInt(e.target.value) || 99,
                          })
                        }
                      />
                    </div>
          ...
          <Card className="py-4">
              ...
              <div className="flex items-center justify-between">
                ...
                {data.type !== "object" && (
                  <Button
                    ...
                    onClick={addModifier}
                    disabled={
                      data.attributeModifiers.length >=
                      distributableAttrs.length
                    }
                  >
            ...
            <CardContent>
              {data.type === "object" ? (
                ...
                <div className="text-center py-8 text-muted-foreground">
                  No distributable attributes defined. Create some attributes
                  first.
                </div>
              ) : (
                      ...
                      >
                        <div className="flex-1">
                          <Select
                            ...
                            onValueChange={(v) =>
                              updateModifier(index, { attributeId: v })
                            }
                          >
                            <SelectTrigger className="bg-transparent">
                              <SelectValue />
                          ...
                          <Input
                            ...
                            onChange={(e) =>
                              updateModifier(index, {
                                modifier: Number.parseInt(e.target.value) || 0,
                              })
                            }
                            placeholder="+/-"
                          />
                    ...
                    data.attributeModifiers.length > 0 && (
                      <div className="p-4 rounded-lg bg-yellow-500/10 border border-yellow-500/20">
                        <p className="text-sm text-yellow-600">
                          When consumed, these modifiers will be permanently
                          added to the character's base attributes, and the item
                          will be destroyed.
                        </p>
                      </div>
                    )}
                    ...
                    data.attributeModifiers.length > 0 && (
                      <div className="p-4 rounded-lg bg-blue-500/10 border border-blue-500/20">
                        <p className="text-sm text-blue-600">
                          These modifiers are applied while the item is equipped

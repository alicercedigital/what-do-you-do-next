...
export function CharacterCreator() {
  ...
  const [attributes, setAttributes] = useState<Record<string, number>>(() => {
    ...
    return Object.fromEntries(selectedUniverse.charactersAttributes.map((attr) => [attr.id, 1]))
  })
  ...
  const handleStartGame = () => {
    ...
    startGame()
    setName("")
    setAttributes(Object.fromEntries(selectedUniverse!.charactersAttributes.map((attr) => [attr.id, 1])))
  }
          ...
          <CardContent className="space-y-6">
            ...
            <div>
              ...
              <div className="space-y-4">
                {selectedUniverse.charactersAttributes.map((attr, index) => (
                  <motion.div
                    key={attr.id}

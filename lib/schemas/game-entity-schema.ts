...
export const AttributeDisplayConfigSchema = z.object({
  ...
  showPercentage: z.boolean().default(false), // Show % on bars
...
export type AttributeDisplayConfig = z.infer<typeof AttributeDisplayConfigSchema>
...
export const GameAttributeSchema = z.object({
  ...
  shortName: z.string().optional().describe("Short name for display (e.g., 'HP' for 'Health Points')"),
...
export const GameUniverseSchema = z.object({
  ...
  // Item system
  equipmentSlots: z.array(z.string()).default(["Head", "Body", "Main Hand", "Off Hand", "Accessory"]),
